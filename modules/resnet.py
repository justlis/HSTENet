...
from .tes import TemporalExtensionShift
__all__ = [
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000):
        ...
        self.shift1 = TemporalExtensionShift(128)
        self.layer3 = self._make_layer(block, 256, layers[2], stride=2)
        self.shift2 = TemporalExtensionShift(256)
        self.alpha = nn.Parameter(torch.zeros(3), requires_grad=True)
        self.layer4 = self._make_layer(block, 512, layers[3], stride=2)
        self.shift3 = TemporalExtensionShift(512)
